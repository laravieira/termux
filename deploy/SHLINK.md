...
### Download your project on `~/projects` folder
```shell
pkg install php composer rsync -y
cd ~/projects
...
### Reference
[shlinkio/shlink](https://github.com/shlinkio/shlink?tab=readme-ov-file#self-hosted)